...
preferred_genre = input(
    "הזן את ז'אנר המוזיקה המועדף עליך (לדוגמה: קלאסי, ג'אז, רוק): ")
preferred_tempo = int(input("הזן את קצב (טמפו) המוזיקה המועדף עליך (BPM): "))
...
for i in range(num_music_pieces):
    ...
    print(f'קטע מוזיקלי {i + 1} נוצר ונשמר כ- {midi_file}')

print('יצירת המוזיקה הושלמה!')